...
class EmailBuilder {
    ...
    /**
     * The email confirmation content builder
     * @param name the user's name
     * @param link the link to press in order to confirm registration
    ...
    static String buildEmail(String name, String link) {
        return '\n' +
                ...
                "                                create an account with <h3>Chat App</h3>you can safely delete\n" +
                "                                this email.</p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <!-- end copy -->\n" +
                ...
                "                            <p style=\"margin: 0;\">Cheers,<br> Chat App</p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <!-- end copy -->\n" +
                '\n' +
                ...
                "     <p style=\"margin: 0;\">Chat App at 1234 S. Broadway Eden. City, Hadi State 12345</p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <!-- end unsubscribe -->\n" +
                '\n' +
